		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Super Fiori App",
									"targetURL": "#atclouddnastudent04zhoiu5vn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnastudent04zhoiu5vn-display": {
								"semanticObject": "atclouddnastudent04zhoiu5vn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.student04.zhoiu5vn",
									"url": sap.ui.require.toUrl("at/clouddna/student04/zhoiu5vn")
								}
							}
						}
					}
